...
4. Register the certificate file in **Register Certificate**.
    ...
    * For supported type of certificate file (.pem), see '[Troubleshooting Guide > Converting Certificate File Formats](./troubleshooting-guide.md#converting-certificate-file-formats)'.
